    ...
    <html lang="id">
      ...
      <body className={inter.className}>
        ...
        <script dangerouslySetInnerHTML={{
          __html: `(function(){try{var host=typeof location!=='undefined'?location.hostname:'';var blocked=['cca-lite.coinbase.com','cca.coinbase.com','coinbase.com/amp','cca-lite.coinbase.com/metrics','api.developer.coinbase.com/analytics','api.developer.coinbase.com'];var isBlocked=function(u){try{return blocked.some(function(b){return u&&u.indexOf(b)!==-1});}catch(e){return false}};if(window.fetch){var _f=window.fetch;window.fetch=function(input,init){try{var url=typeof input==='string'?input:(input&&input.url)||'';if(isBlocked(url))return Promise.resolve(new Response(null,{status:204}));}catch(e){}return _f.apply(this,arguments);};}
        ...
        window.addEventListener('unhandledrejection',function(e){if(e.reason&&typeof e.reason==='object'&&e.reason.message&&e.reason.message.indexOf('analytics')!==-1){e.preventDefault();}});
        window.addEventListener('error',function(e){if(e.message&&e.message.indexOf('analytics')!==-1){e.preventDefault();}});
        }catch(e){}})();`
        }} />
      </body>
    </html>
